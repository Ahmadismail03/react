          ...
          {user ? (
            <Box sx={{ flexGrow: 0 }}>
              <Tooltip title="Notifications">
                <IconButton onClick={handleOpenNotifications} sx={{ p: 0, mr: 2 }}>
              ...
              >
                <MenuItem>
                  <Typography textAlign="center">New course available</Typography>
                </MenuItem>
                <MenuItem>
                  <Typography textAlign="center">Assignment due soon</Typography>
                </MenuItem>
                <MenuItem>
                  <Typography textAlign="center">Grade posted</Typography>
                </MenuItem>
                <MenuItem>
